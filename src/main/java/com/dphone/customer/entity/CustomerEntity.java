...
public class CustomerEntity {
    ...
    public CustomerEntity(long customer_id, String customer_first_name, String customer_last_name, String username, long customer_mobile) {
